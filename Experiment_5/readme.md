     This experimental code is to compare total payments.

experiment_5_generate_data.py : The code that generates the data.
...
experiment_5_user_xx.txt : Data of xx users participating in the auction mechanism.
