...
cost_uav = 0
with open("../Experiment_6/experiment_6_user.txt", 'r', encoding='utf8') as user_file:
    ...
    bids[20] =17.51
    # print(bids)
with open("../Experiment_6/uav_data.txt", 'r', encoding="utf8") as uav_file:
...
print(last_winner)
print(pay)
print("改变出价之后用户20的出价", bids[20])
print("支付给用户2的金额", pay[20 - 1])
print("用户20的效用", pay[20 - 1] - 24.5)
# print((pay[10-1]))
